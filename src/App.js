...
function App() {
  ...
  const listaErrosGeo = [{"codigo":1, "texto": "Não foi dada permissão para o sistema encontrar a sua localização"},{"codigo":2, "texto": "Não foi possivel obter a sua localização"},{"codigo":3, "texto": "O tempo para obter a sua localização foi expirado"}]
    ...
    <>  {/* React Fragment */}
      ...
      {erro &&
        <Toast onClose={() => setErro(null)} delay={4000} autohide className="bg-danger">
          ...
          <ToastBody className="bg-white text-danger">Por favor, faça uma nova busca</ToastBody>
        </Toast>
      }
      {obtendoClima &&
